<div>
    <div>
        <!-- Modal -->
        <div class="modal fade" id="RolloModal" tabindex="-1" aria-labelledby="RolModalLabel" aria-hidden="true" wire:ignore.self>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12">
                                        ...
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#RolModal" wire:click='modal()'>
                                            Create teacher
                                        </button>
                                    </div>
                                </div>
                                        ...
                                        <td>
                                            <ul class="list-inline me-auto mb-0">
                                                <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" aria-label="Edit" data-bs-original-title="Edit">
                                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#RolModal" wire:click="modal({{ $modulo->id }})">
                                                        EDIT
                                                    </button>
                                                </li>
